...
public partial class NorthwindContext : DbContext
{
    ...
    public virtual DbSet<ContactDirectoryX> ContactDirectoryXes { get; set; }
    ...
    public virtual DbSet<OrdersForCustomersWhoseNameStartsWithA> OrdersForCustomersWhoseNameStartsWithAs { get; set; }

    public virtual DbSet<OrdersQry> OrdersQries { get; set; }

    public virtual DbSet<People> People { get; set; }

    public virtual DbSet<PetesView> PetesViews { get; set; }
    ...
    public virtual DbSet<ProductsByCategorySorted> ProductsByCategorySorteds { get; set; }

    public virtual DbSet<ProductsByCategoryXxx> ProductsByCategoryXxxes { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=.\SQLExpress;Encrypt=False;Database=Northwind;Trusted_Connection=True");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<ContactDirectory>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ContactDirectory");

            entity.Property(e => e.CompanyName).HasMaxLength(40);
            entity.Property(e => e.ContactName).HasMaxLength(31);
            entity.Property(e => e.Phone).HasMaxLength(24);
        });

        modelBuilder.Entity<ContactDirectoryX>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ContactDirectoryX");
        ...
        modelBuilder.Entity<OrdersForCustomersWhoseNameStartsWithA>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("OrdersForCustomersWhoseNameStartsWithA");
        ...
        modelBuilder.Entity<PetesView>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("PetesView");
        ...
        modelBuilder.Entity<ProductsByCategorySorted>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("ProductsByCategorySorted");
        ...
        modelBuilder.Entity<ProductsByCategoryXxx>(entity =>
        {
            entity
                .HasNoKey()
                .ToView("Products by Category XXX");
