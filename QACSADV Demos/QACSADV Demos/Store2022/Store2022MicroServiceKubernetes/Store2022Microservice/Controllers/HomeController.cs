    ...
    public class HomeController : Controller
    {
        ...
        public HomeController()
        {
            if (ACCOUNT_SERVICE_API_BASE == null)
            {
                ...
                ACCOUNT_SERVICE_API_BASE = "http://account2022backend:5001/api";
                //ACCOUNT_SERVICE_API_BASE = "http://accountservice:32001/api";
            }

            if (INVENTORY_SERVICE_API_BASE == null)
            {
                //INVENTORY_SERVICE_API_BASE = "http://localhost:5002/api";
                INVENTORY_SERVICE_API_BASE = "http://inventory2022backend:5002/api";
                //INVENTORY_SERVICE_API_BASE = "http://inventoryservice:32002/api";
            }

            if (SHOPPING_SERVICE_API_BASE == null)
            {
                //SHOPPING_SERVICE_API_BASE = "http://localhost:5003/api";
                SHOPPING_SERVICE_API_BASE = "http://shopping2022backend:5003/api";
                //SHOPPING_SERVICE_API_BASE = "http://shoppingservice:32003/api";
            }
        }
